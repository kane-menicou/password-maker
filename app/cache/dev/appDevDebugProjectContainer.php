...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\PasswordService A AppBundle\Services\PasswordService instance
     */
    protected function getPassword_ServiceService()
    {
        return $this->services['password.service'] = new \AppBundle\Services\PasswordService();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\QuickPasswordBundle/Resources/views'), 'QuickPassword');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5827b1ea3fc4b8.21364392')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'QuickPasswordBundle' => 'QuickPasswordBundle\\QuickPasswordBundle',
